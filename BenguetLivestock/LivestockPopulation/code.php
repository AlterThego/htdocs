...
if (isset($_POST['savedata'])) {
    ...
    $update_carabao_count = mysqli_real_escape_string($connection, $_POST['update_carabao_count']);
    $update_cattle_count = mysqli_real_escape_string($connection, $_POST['update_cattle_count']);
    $update_swine_count = mysqli_real_escape_string($connection, $_POST['update_swine_count']);
    $update_goat_count = mysqli_real_escape_string($connection, $_POST['update_goat_count']);
    $update_dog_count = mysqli_real_escape_string($connection, $_POST['update_dog_count']);
    $update_sheep_count = mysqli_real_escape_string($connection, $_POST['update_sheep_count']);
    $update_horse_count = mysqli_real_escape_string($connection, $_POST['update_horse_count']);
    ...
    mysqli_stmt_bind_param($stmt, "iiiiiiisi", $update_carabao_count, $update_cattle_count, $update_swine_count, $update_goat_count, $update_dog_count, $update_sheep_count, $update_horse_count, $update_date, $update_id);
