        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a href="../Dashboard/index.php" class="sidebar-link" id="dashboard-link">
                    <img src="\BenguetLivestockdb\images\dashboard.png" alt="Logo" style="height: 25px; width: 25px;"
                        class="img mr-2">
                    Dashboard
                </a>
            </li>
            ...
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed" data-bs-toggle="collapse" data-bs-target="#population"
                    ...
                    <img src="/BenguetLivestockdb/images/population.png" alt="Logo" style="height: 25px; width: 25px;"
                        class="img mr-2">
                    Population
                </a>
                <ul id="population" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item">
                        <a href="../LivestockVolume/index.php" class="sidebar-link" data-bs-parent="#population"><img
                                src="/BenguetLivestockdb/images/weight.png" alt="Logo"
